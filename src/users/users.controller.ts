...
import { Body, Controller, Delete, Get, HttpCode, Param, Post, Put, Query, Req, Res, UploadedFiles, UseGuards, UseInterceptors } from '@nestjs/common';
...
// встановити постмен агент. розібратись з відправкою файлів через нього. додати залежності щоб можна було відправляти файли